    ...
    messages=[
        {
            "role": "user",
            "content": """
            Extract details from the job descriptions:
            1. Senior Technical Program Manager, Network Infrastructure and Capacity Planning
            ...
            2. Product Strategy and Operations Principal, AI2 Strategic Partnerships
            Minimum qualifications:
            ...
            3. Customer Engineering Manager IV, Google Cloud
            Minimum qualifications:
            Bachelor's degree or equivalent practical experience.
